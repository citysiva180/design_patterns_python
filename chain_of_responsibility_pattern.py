...
# In a HTTP Request Handling, we understand some requests have to go through
# Authentication, Authorization, Payload handling. In this case, we give the
# Chain of responsibility pattern in which each request handlers direct the request
# to the next function which processes the request. This is the chain of responsibility
# principle

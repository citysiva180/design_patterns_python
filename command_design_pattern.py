...
# In Command Design Pattern , instead of sending all requests all together 
# into the backend, a processor is implemented where it handles all requests 
# and then sends it back to the backend. This way requests are present in a queue 
# by which it is executed sequentially 
